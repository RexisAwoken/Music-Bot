...
module.exports = {
    ...
    async execute(client, message, args) {
        //const cmd = message.content.split(' ').shift() //this should work
        ...
        if (!voice_channel) return message.lineReply(voiceError);
        ...
        //if (cmd === 'play'){
        if (!args.length) return message.channel.send('You need to send something to play!');
        let song = {};
